function usage()
  io.stderr:write("usage: patch-wad [<gzinject-arg>...] [-s] [-m <input-rom>]"
                  .. " [-o <output-wad>] <input-wad>\n")
  os.exit(1)
end
...
if rom_info == nil then
  io.stderr:write("patch-wad: unrecognized rom: " .. opt_rom .. "\n")
  return 2
end
...
patch:apply(rom)
rom:save_file(opt_directory .. "/content5/rom")
...
if not opt_nohb and vc_version ~= nil then
  gzinject_cmd = gzinject_cmd ..  " -p \"gzi/hb_" .. vc_version ..
                 ".gzi\" --dol-inject \"homeboy/bin/hb-" .. vc_version ..
                 "/homeboy.bin\" --dol-loading 80300000"
end
...
if opt_sub then print(rom_info.gz_name .. ".wad") end
